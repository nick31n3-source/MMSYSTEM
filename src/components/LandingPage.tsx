...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  ...
  const scrollToEficiencia = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    const eficienciaSection = document.getElementById('eficiencia');
    if (eficienciaSection) {
      eficienciaSection.scrollIntoView({ behavior: 'smooth' });
    }
  };
      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-[#070b14]/90 backdrop-blur-md border-b border-white/5">
        <div className="max-w-[1200px] mx-auto px-6 h-[72px] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <svg width="28" height="28" viewBox="0 0 100 100" className="drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
      ...
      <main className="pt-32 pb-20 px-6 max-w-[1000px] mx-auto space-y-32">
        ...
        <section className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 space-y-6">
            ...
            <motion.div 
              ...
              className="pt-2"
            >
              <button onClick={scrollToEficiencia} className="px-8 py-3 rounded-full border border-cyan-500 bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 font-bold text-sm transition-all shadow-[0_0_20px_rgba(6,182,212,0.2)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] cursor-pointer">
          ...
          <div className="flex-1 relative flex justify-center items-center h-[400px]">
            ...
            <div className="relative w-full h-full flex justify-center items-center">
              ...
              <svg width="100%" height="100%" viewBox="0 0 100 100" className="relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]">
                <defs>
                   <filter id="cyan-glow">
                ...
                <path d="M 41 55.1 L 41 40.1 L 50 49.1 L 59 40.1 L 59 55.1 L 54.5 59.6 L 54.5 46.1 L 50 50.6 L 45.5 46.1 L 45.5 59.6 Z" fill="none" stroke="#22d3ee" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-center -mt-10">
          <div className="w-16 h-16 relative flex justify-center items-center animate-bounce">
             ...
             <svg width="40" height="40" viewBox="0 0 100 100" className="drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] relative z-10">
                <path d="M 20 67 L 20 17 L 50 47 L 80 17 L 80 67 L 65 82 L 65 37 L 50 52 L 35 37 L 35 82 Z" fill="none" stroke="#22d3ee" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        ...
        <section className="space-y-6">
          ...
          <div className="w-full h-72 bg-[#091018] border border-[#14293a] rounded-[1.5rem] p-6 relative overflow-hidden flex flex-col justify-between shadow-[0_0_30px_rgba(255,255,255,0.05)]">
              <div className="flex justify-between items-start text-cyan-500 font-mono z-10 relative">
                <div>
                   <div className="text-2xl font-bold text-white">99.9%</div>
                   <div className="text-[10px] tracking-widest text-slate-500 font-sans font-bold uppercase mt-1">PRECISÃO</div>
                </div>
             ...
             <div className="absolute inset-0 flex items-center justify-center opacity-90 pointer-events-none mt-8">
                <svg width="100%" height="100%" viewBox="0 0 800 300" className="opacity-90">
                  ...
                  <g fill="#0891b2" filter="url(#glow)">
                    ...
                    <circle cx="250" cy="150" r="8" fill="#ffffff" />
                    <circle cx="250" cy="200" r="8" fill="#ffffff" />
                    <circle cx="250" cy="250" r="6" />
                    {/* Layer 3 - Center */}
                    <circle cx="400" cy="50" r="10" />
                    <circle cx="400" cy="150" r="18" fill="#ffffff" />
                    <circle cx="400" cy="250" r="10" />
                    {/* Layer 4 */}
                    <circle cx="550" cy="50" r="6" />
                    <circle cx="550" cy="100" r="8" fill="#ffffff" />
                    <circle cx="550" cy="150" r="8" fill="#ffffff" />
                    <circle cx="550" cy="200" r="8" fill="#ffffff" />
                    <circle cx="550" cy="250" r="6" />
                    {/* Layer 5 */}
                    <circle cx="700" cy="100" r="4" fill="#ffffff" />
                    <circle cx="700" cy="150" r="5" fill="#ffffff" />
             ...
             <div className="text-right z-10 relative">
                <div className="text-[10px] text-slate-500 font-bold tracking-widest uppercase">
                   TAXA DE CRESCIMENTO<br/>DA REDE NEURAL
                </div>
             </div>
          </div>
        </section>
        ...
        <section id="eficiencia" className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-4">
            <div className="flex flex-col items-center gap-4">
               ...
               <h3 className="font-medium text-sm text-white">Fluxos de Trabalho<br/>Otimizados</h3>
            </div>
            <div className="flex flex-col items-center gap-4">
               <div className="w-16 h-16 rounded-2xl border border-cyan-500/20 bg-[#0c1622] flex items-center justify-center text-cyan-400 drop-shadow-[0_0_15px_rgba(6,182,212,0.3)]">
                  <Zap className="w-8 h-8 stroke-[1.5]" />
               </div>
               <h3 className="font-medium text-sm text-white">Análises Mais<br/>Rápidas</h3>
            </div>
            <div className="flex flex-col items-center gap-4">
               <div className="w-16 h-16 rounded-2xl border border-cyan-500/20 bg-[#0c1622] flex items-center justify-center text-cyan-400 drop-shadow-[0_0_15px_rgba(6,182,212,0.3)]">
                  <Target className="w-8 h-8 stroke-[1.5]" />
               </div>
               <h3 className="font-medium text-sm text-white">Decisões Baseadas<br/>em Dados</h3>
            </div>
          </div>
        </section>
        ...
        <section id="sobre-nos" className="space-y-6 pt-10 pb-10">
          <div>
            ...
            <p className="text-slate-400 text-[13px]">Nossa Visão para Eficiência Inteligente</p>
          </div>
          ...
          <div className="flex justify-center pt-24 pb-8">
             <div className="relative w-16 h-16 flex justify-center items-center">
                ...
                <svg width="48" height="48" viewBox="0 0 100 100" className="drop-shadow-[0_0_8px_rgba(255,255,255,1)] relative z-10">
                  <path d="M 20 67 L 20 17 L 50 47 L 80 17 L 80 67 L 65 82 L 65 37 L 50 52 L 35 37 L 35 82 Z" fill="none" stroke="#22d3ee" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
             </div>
          </div>
